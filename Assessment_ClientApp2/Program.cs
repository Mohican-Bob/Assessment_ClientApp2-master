...
namespace Assessment_ClientApp2
{
    ...
    class Program
    {
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            Console.Write("\tTribe: ");
            Enum.TryParse(Console.ReadLine(), out Monster.Tribe Group);
            newMonster.Group = Group;
            Console.Write("\tTribe status: ");
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            Console.Write($"\tCurrent Tribe: {selectedMonster.Group} New Attitude: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
                Enum.TryParse(userResponse, out Monster.Tribe Group);
                selectedMonster.Group = Group;
            }
            Console.Write($"\tCurrent Status: {selectedMonster.Active} New Status: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
                bool.TryParse(userResponse, out bool status);
                selectedMonster.Active = status;
            }
        ...
        static void MonsterInfo(Monster monster)
        {
            ...
            Console.WriteLine($"\tTribe: {monster.Group}");
